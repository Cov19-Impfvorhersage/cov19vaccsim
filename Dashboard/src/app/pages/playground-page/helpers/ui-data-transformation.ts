...
import { getWeekdayInYearWeek, getYearWeekOfDate } from '../../../simulation/calendarweek/calendarweek';
...
export class UiDataTransformation {
    ...
    buildChartPopulation(
        ...
        if (results) {
            ...
            const parts = [];
            let colorI = 0;
            const partitions = simulation.partitionings[displayPartitioning].partitions;
    ...
    buildChart7DayVaccinations(dataloader: DataloaderService, simulation: BasicSimulation): ChartData {
        const newData: ChartData = {
            yMin: 0,
            yMax: 7_000_000,
            series: [],
    ...
    buildChartCumulativeDeliveries(
        dataloader: DataloaderService,
        simulation: BasicSimulation,
        results: ISimulationResults,
    ): ChartData {
