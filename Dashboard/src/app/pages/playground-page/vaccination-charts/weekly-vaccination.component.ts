...
@Component({
    selector: 'app-weekly-vaccination',
    template: `
        <div class="top-bar">
        ...
        <app-prediction-line-chart
            class="main-chart"
            style="width: 100%"
            [data]="ui.dataTransform.chartWeeklyVaccinations"
            [config]="ui.chartConfig.chartWeeklyVaccinationsConfig"
        ></app-prediction-line-chart>
    `,
    styleUrls: ['./vaccination-charts.styles.scss']
})
export class WeeklyVaccinationComponent {
