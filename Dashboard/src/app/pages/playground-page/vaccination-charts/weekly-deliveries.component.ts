...
@Component({
    selector: 'app-weekly-deliveries',
    template: `
        <div class="top-bar">
        ...
        <app-prediction-line-chart
            class="main-chart"
            style="width: 100%"
            [data]="ui.dataTransform.chartWeeklyDeliveries"
            [config]="ui.chartConfig.chartWeeklyDeliveriesConfig"
        ></app-prediction-line-chart>
    `,
    styleUrls: ['./vaccination-charts.styles.scss']
})
export class WeeklyDeliveriesComponent {
